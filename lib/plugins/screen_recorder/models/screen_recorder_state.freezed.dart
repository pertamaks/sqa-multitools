...
mixin _$ScreenRecorderState {
 ...
 String? get primaryDisplayId; List<RecordingInfo> get recentRecordings; Display? get lockedDisplay; bool get textHasBackground; bool get isLongScreenshotSession; String get searchQuery;@JsonKey(includeFromJson: false, includeToJson: false) HotKey? get registeredHotKey;
...
switch (_that) {
case _ScreenRecorderState() when $default != null:
return $default(_that.isRecording,_that.isPaused,_that.durationSeconds,_that.microphoneEnabled,_that.systemAudioEnabled,_that.showCursor,_that.resolution,_that.format,_that.captureMode,_that.isOverlayVisible,_that.availableAudioDevices,_that.selectedAudioDevice,_that.clickFeedbackColor,_that.rightClickFeedbackColor,_that.annotations,_that.currentTool,_that.annotationColor,_that.delaySeconds,_that.countdownSeconds,_that.framerate,_that.saveDirectory,_that.previousWindowSize,_that.previousWindowPos,_that.selectionRect,_that.captureRect,_that.availableDisplays,_that.monitorNames,_that.displayThumbnails,_that.primaryDisplayId,_that.recentRecordings,_that.lockedDisplay,_that.textHasBackground,_that.isLongScreenshotSession,_that.searchQuery,_that.registeredHotKey);case _:
  return orElse();
