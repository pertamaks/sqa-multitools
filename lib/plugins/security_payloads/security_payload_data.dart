...
class SecurityPayloadData {
  static const List<VulnerabilityCategory> webCategories = [
    VulnerabilityCategory(
      name: 'SQL Injection',
      description:
          'Injecting malicious SQL queries to manipulate back-end databases.',
      ...
      payloads: [
        ...
        SecurityPayload(
          ...
          description:
              'Forces the database to reveal version information in an error message.',
          howToTest: 'Inject into URL parameters or input fields.',
          successIndicator:
              'Application displays a database error containing version strings.',
        ...
        SecurityPayload(
          ...
          description:
              'Appends results from another query to the original result set.',
          howToTest: 'Inject into a search field or item ID.',
          successIndicator:
              'Database details appear on the page where data is normally displayed.',
    ...
    VulnerabilityCategory(
      ...
      payloads: [
        ...
        SecurityPayload(
          ...
          successIndicator:
              'A browser alert box appears when the image fails to load.',
          risk: PayloadRisk.high,
        ),
        SecurityPayload(
          name: 'SVG Vector',
          ...
          description:
              'Another vector that often bypasses simple sanitization.',
    ...
    VulnerabilityCategory(
      ...
      payloads: [
        SecurityPayload(
          ...
          howToTest:
              'Inject into fields that might be passed to a shell (e.g., printer names, IP lookups).',
          successIndicator:
              'Output of the directory listing appears in the UI.',
          risk: PayloadRisk.critical,
        ),
        SecurityPayload(
          name: 'Logical AND',
