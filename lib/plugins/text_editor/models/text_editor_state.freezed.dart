...
mixin _$TextEditorState {
 ...
 List<TextDocument> get documents; TextDocument? get activeDocument; TextEditorViewMode get viewMode; bool get isSaving; String? get errorMessage;
...
@override
String toString() {
  return 'TextEditorState(documents: $documents, activeDocument: $activeDocument, viewMode: $viewMode, isSaving: $isSaving, errorMessage: $errorMessage)';
}
...
@useResult
$Res call({
 List<TextDocument> documents, TextDocument? activeDocument, TextEditorViewMode viewMode, bool isSaving, String? errorMessage
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<TextDocument> documents,  TextDocument? activeDocument,  TextEditorViewMode viewMode,  bool isSaving,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TextEditorState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<TextDocument> documents,  TextDocument? activeDocument,  TextEditorViewMode viewMode,  bool isSaving,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _TextEditorState():
return $default(_that.documents,_that.activeDocument,_that.viewMode,_that.isSaving,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<TextDocument> documents,  TextDocument? activeDocument,  TextEditorViewMode viewMode,  bool isSaving,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _TextEditorState() when $default != null:
return $default(_that.documents,_that.activeDocument,_that.viewMode,_that.isSaving,_that.errorMessage);case _:
  return null;
...
class _TextEditorState implements TextEditorState {
  const _TextEditorState({final  List<TextDocument> documents = const [], this.activeDocument, this.viewMode = TextEditorViewMode.list, this.isSaving = false, this.errorMessage}): _documents = documents;
