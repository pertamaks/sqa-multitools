...
mixin _$ScreenRecorderState {
 ...
 bool get isRecording; bool get isPaused; int get durationSeconds; bool get microphoneEnabled; bool get systemAudioEnabled; bool get showCursor; String get resolution; String get format; CaptureMode get captureMode; String get targetWindowName; bool get isOverlayVisible; bool get isTargetingWindow; Rect? get targetedWindowRect; List<Annotation> get annotations; ScreenshotTool get currentTool; Color get annotationColor; int get delaySeconds; int get countdownSeconds;// Live countdown before recording starts
...
switch (_that) {
case _ScreenRecorderState() when $default != null:
return $default(_that.isRecording,_that.isPaused,_that.durationSeconds,_that.microphoneEnabled,_that.systemAudioEnabled,_that.showCursor,_that.resolution,_that.format,_that.captureMode,_that.targetWindowName,_that.isOverlayVisible,_that.isTargetingWindow,_that.targetedWindowRect,_that.annotations,_that.currentTool,_that.annotationColor,_that.delaySeconds,_that.countdownSeconds,_that.framerate,_that.engineDownloadProgress,_that.engineReady,_that.saveDirectory,_that.previousWindowSize,_that.previousWindowPos,_that.selectionRect,_that.captureRect,_that.availableDisplays,_that.monitorNames,_that.displayThumbnails,_that.primaryDisplayId);case _:
  return orElse();
