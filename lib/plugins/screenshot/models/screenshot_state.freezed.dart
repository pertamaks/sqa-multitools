...
mixin _$ScreenshotState {
 ...
 CaptureMode get captureMode; String get format; bool get isCapturing; ScreenshotTool get currentTool; Color get annotationColor; bool get isOverlayVisible; Rect? get selectionRect; List<Annotation> get annotations; String? get saveDirectory; Size? get previousWindowSize; Offset? get previousWindowPos; List<Display> get availableDisplays; List<CaptureInfo> get recentCaptures; bool get textHasBackground; String get searchQuery; Display? get lockedDisplay; Uint8List? get frozenBackgroundBytes;
...
@useResult
$Res call({
 CaptureMode captureMode, String format, bool isCapturing, ScreenshotTool currentTool, Color annotationColor, bool isOverlayVisible, Rect? selectionRect, List<Annotation> annotations, String? saveDirectory, Size? previousWindowSize, Offset? previousWindowPos, List<Display> availableDisplays, List<CaptureInfo> recentCaptures, bool textHasBackground, String searchQuery, Display? lockedDisplay, Uint8List? frozenBackgroundBytes
});
...
/// Create a copy of ScreenshotState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? captureMode = null,Object? format = null,Object? isCapturing = null,Object? currentTool = null,Object? annotationColor = null,Object? isOverlayVisible = null,Object? selectionRect = freezed,Object? annotations = null,Object? saveDirectory = freezed,Object? previousWindowSize = freezed,Object? previousWindowPos = freezed,Object? availableDisplays = null,Object? recentCaptures = null,Object? textHasBackground = null,Object? searchQuery = null,Object? lockedDisplay = freezed,Object? frozenBackgroundBytes = freezed,}) {
...
as List<Annotation>,saveDirectory: freezed == saveDirectory ? _self.saveDirectory : saveDirectory // ignore: cast_nullable_to_non_nullable
...
as Display?,frozenBackgroundBytes: freezed == frozenBackgroundBytes ? _self.frozenBackgroundBytes : frozenBackgroundBytes // ignore: cast_nullable_to_non_nullable
as Uint8List?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( CaptureMode captureMode,  String format,  bool isCapturing,  ScreenshotTool currentTool,  Color annotationColor,  bool isOverlayVisible,  Rect? selectionRect,  List<Annotation> annotations,  String? saveDirectory,  Size? previousWindowSize,  Offset? previousWindowPos,  List<Display> availableDisplays,  List<CaptureInfo> recentCaptures,  bool textHasBackground,  String searchQuery,  Display? lockedDisplay,  Uint8List? frozenBackgroundBytes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ScreenshotState() when $default != null:
return $default(_that.captureMode,_that.format,_that.isCapturing,_that.currentTool,_that.annotationColor,_that.isOverlayVisible,_that.selectionRect,_that.annotations,_that.saveDirectory,_that.previousWindowSize,_that.previousWindowPos,_that.availableDisplays,_that.recentCaptures,_that.textHasBackground,_that.searchQuery,_that.lockedDisplay,_that.frozenBackgroundBytes);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( CaptureMode captureMode,  String format,  bool isCapturing,  ScreenshotTool currentTool,  Color annotationColor,  bool isOverlayVisible,  Rect? selectionRect,  List<Annotation> annotations,  String? saveDirectory,  Size? previousWindowSize,  Offset? previousWindowPos,  List<Display> availableDisplays,  List<CaptureInfo> recentCaptures,  bool textHasBackground,  String searchQuery,  Display? lockedDisplay,  Uint8List? frozenBackgroundBytes)  $default,) {final _that = this;
switch (_that) {
case _ScreenshotState():
return $default(_that.captureMode,_that.format,_that.isCapturing,_that.currentTool,_that.annotationColor,_that.isOverlayVisible,_that.selectionRect,_that.annotations,_that.saveDirectory,_that.previousWindowSize,_that.previousWindowPos,_that.availableDisplays,_that.recentCaptures,_that.textHasBackground,_that.searchQuery,_that.lockedDisplay,_that.frozenBackgroundBytes);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( CaptureMode captureMode,  String format,  bool isCapturing,  ScreenshotTool currentTool,  Color annotationColor,  bool isOverlayVisible,  Rect? selectionRect,  List<Annotation> annotations,  String? saveDirectory,  Size? previousWindowSize,  Offset? previousWindowPos,  List<Display> availableDisplays,  List<CaptureInfo> recentCaptures,  bool textHasBackground,  String searchQuery,  Display? lockedDisplay,  Uint8List? frozenBackgroundBytes)?  $default,) {final _that = this;
switch (_that) {
case _ScreenshotState() when $default != null:
return $default(_that.captureMode,_that.format,_that.isCapturing,_that.currentTool,_that.annotationColor,_that.isOverlayVisible,_that.selectionRect,_that.annotations,_that.saveDirectory,_that.previousWindowSize,_that.previousWindowPos,_that.availableDisplays,_that.recentCaptures,_that.textHasBackground,_that.searchQuery,_that.lockedDisplay,_that.frozenBackgroundBytes);case _:
  return null;
...
class _ScreenshotState implements ScreenshotState {
  const _ScreenshotState({this.captureMode = CaptureMode.area, this.format = 'PNG', this.isCapturing = false, this.currentTool = ScreenshotTool.pointer, this.annotationColor = Colors.red, this.isOverlayVisible = false, this.selectionRect = null, final  List<Annotation> annotations = const [], this.saveDirectory, this.previousWindowSize, this.previousWindowPos, final  List<Display> availableDisplays = const [], final  List<CaptureInfo> recentCaptures = const [], this.textHasBackground = false, this.searchQuery = '', this.lockedDisplay, this.frozenBackgroundBytes}): _annotations = annotations,_availableDisplays = availableDisplays,_recentCaptures = recentCaptures;
...
@override final  Uint8List? frozenBackgroundBytes;
...
@override
int get hashCode => Object.hash(runtimeType,captureMode,format,isCapturing,currentTool,annotationColor,isOverlayVisible,selectionRect,const DeepCollectionEquality().hash(_annotations),saveDirectory,previousWindowSize,previousWindowPos,const DeepCollectionEquality().hash(_availableDisplays),const DeepCollectionEquality().hash(_recentCaptures),textHasBackground,searchQuery,lockedDisplay,const DeepCollectionEquality().hash(frozenBackgroundBytes));
