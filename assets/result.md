...
> [!CAUTION]
**Nested Complexity Test**This is a nested quote inside a Caution block.It contains a list.And a `code snippet`.
---
...
|Math|Logic|Entities|
|:---|:---|:---|
|$x_{n+1} = \frac{x_n}{2}$|$A \implies B$|© ® ™ ±|
|$\sum_{i=1}^{\infty} \frac{1}{n^2}$|$\forall x \in \mathbb{R}$|😀 (Unicode)|

---
## 8. Footnotes & Back-references <a name="footnote-anchor"></a>

The placement of this footnote should be at the very bottom of the rendered page, regardless of where it is defined in the source[1](#fn-table_fn).
...
1. Step three (Should still be numbered '3')

<section class="footnotes"><ol><li id="fn-table_fn"><p><strong>Footnote success!</strong> This footnote includes a <strong>bold statement</strong> and verifies that the anchor link from Section 3 works correctly. <a href="#fnref-table_fn" class="footnote-backref">↩</a></p></li></ol></section>
