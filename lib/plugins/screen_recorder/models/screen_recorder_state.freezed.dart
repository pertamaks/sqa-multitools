...
mixin _$ScreenRecorderState {
 ...
 String? get primaryDisplayId; List<RecordingInfo> get recentRecordings; Display? get lockedDisplay; bool get textHasBackground; bool get isLongScreenshotSession; bool get isStitching; StitchAxis get scrollDirection; String get searchQuery;@JsonKey(includeFromJson: false, includeToJson: false) HotKey? get registeredHotKey;
...
/// Create a copy of ScreenRecorderState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isRecording = null,Object? isPaused = null,Object? durationSeconds = null,Object? microphoneEnabled = null,Object? systemAudioEnabled = null,Object? showCursor = null,Object? resolution = null,Object? format = null,Object? captureMode = null,Object? isOverlayVisible = null,Object? availableAudioDevices = null,Object? selectedAudioDevice = freezed,Object? clickFeedbackColor = null,Object? rightClickFeedbackColor = null,Object? annotations = null,Object? currentTool = null,Object? annotationColor = null,Object? delaySeconds = null,Object? countdownSeconds = null,Object? framerate = null,Object? saveDirectory = freezed,Object? previousWindowSize = freezed,Object? previousWindowPos = freezed,Object? selectionRect = freezed,Object? captureRect = freezed,Object? availableDisplays = null,Object? monitorNames = null,Object? displayThumbnails = null,Object? primaryDisplayId = freezed,Object? recentRecordings = null,Object? lockedDisplay = freezed,Object? textHasBackground = null,Object? isLongScreenshotSession = null,Object? isStitching = null,Object? scrollDirection = freezed,Object? searchQuery = null,Object? registeredHotKey = freezed,}) {
...
as CaptureMode,isOverlayVisible: null == isOverlayVisible ? _self.isOverlayVisible : isOverlayVisible // ignore: cast_nullable_to_non_nullable
as bool,availableAudioDevices: null == availableAudioDevices ? _self.availableAudioDevices : availableAudioDevices // ignore: cast_nullable_to_non_nullable
...
as List<RecordingInfo>,lockedDisplay: freezed == lockedDisplay ? _self.lockedDisplay : lockedDisplay // ignore: cast_nullable_to_non_nullable
as Display?,textHasBackground: null == textHasBackground ? _self.textHasBackground : textHasBackground // ignore: cast_nullable_to_non_nullable
as bool,isLongScreenshotSession: null == isLongScreenshotSession ? _self.isLongScreenshotSession : isLongScreenshotSession // ignore: cast_nullable_to_non_nullable
as bool,isStitching: null == isStitching ? _self.isStitching : isStitching // ignore: cast_nullable_to_non_nullable
as bool,scrollDirection: freezed == scrollDirection ? _self.scrollDirection : scrollDirection // ignore: cast_nullable_to_non_nullable
as StitchAxis,searchQuery: null == searchQuery ? _self.searchQuery : searchQuery // ignore: cast_nullable_to_non_nullable
as String,registeredHotKey: freezed == registeredHotKey ? _self.registeredHotKey : registeredHotKey // ignore: cast_nullable_to_non_nullable
as HotKey?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isRecording,  bool isPaused,  int durationSeconds,  bool microphoneEnabled,  bool systemAudioEnabled,  bool showCursor,  String resolution,  String format,  CaptureMode captureMode,  bool isOverlayVisible,  List<String> availableAudioDevices,  String? selectedAudioDevice,  Color clickFeedbackColor,  Color rightClickFeedbackColor,  List<Annotation> annotations,  ScreenshotTool currentTool,  Color annotationColor,  int delaySeconds,  int countdownSeconds,  int framerate,  String? saveDirectory,  Size? previousWindowSize,  Offset? previousWindowPos,  Rect? selectionRect,  Rect? captureRect,  List<Display> availableDisplays,  Map<String, String> monitorNames,  Map<String, String> displayThumbnails,  String? primaryDisplayId,  List<RecordingInfo> recentRecordings,  Display? lockedDisplay,  bool textHasBackground,  bool isLongScreenshotSession,  bool isStitching,  StitchAxis scrollDirection,  String searchQuery, @JsonKey(includeFromJson: false, includeToJson: false)  HotKey? registeredHotKey)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ScreenRecorderState() when $default != null:
return $default(_that.isRecording,_that.isPaused,_that.durationSeconds,_that.microphoneEnabled,_that.systemAudioEnabled,_that.showCursor,_that.resolution,_that.format,_that.captureMode,_that.isOverlayVisible,_that.availableAudioDevices,_that.selectedAudioDevice,_that.clickFeedbackColor,_that.rightClickFeedbackColor,_that.annotations,_that.currentTool,_that.annotationColor,_that.delaySeconds,_that.countdownSeconds,_that.framerate,_that.saveDirectory,_that.previousWindowSize,_that.previousWindowPos,_that.selectionRect,_that.captureRect,_that.availableDisplays,_that.monitorNames,_that.displayThumbnails,_that.primaryDisplayId,_that.recentRecordings,_that.lockedDisplay,_that.textHasBackground,_that.isLongScreenshotSession,_that.isStitching,_that.scrollDirection,_that.searchQuery,_that.registeredHotKey);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isRecording,  bool isPaused,  int durationSeconds,  bool microphoneEnabled,  bool systemAudioEnabled,  bool showCursor,  String resolution,  String format,  CaptureMode captureMode,  bool isOverlayVisible,  List<String> availableAudioDevices,  String? selectedAudioDevice,  Color clickFeedbackColor,  Color rightClickFeedbackColor,  List<Annotation> annotations,  ScreenshotTool currentTool,  Color annotationColor,  int delaySeconds,  int countdownSeconds,  int framerate,  String? saveDirectory,  Size? previousWindowSize,  Offset? previousWindowPos,  Rect? selectionRect,  Rect? captureRect,  List<Display> availableDisplays,  Map<String, String> monitorNames,  Map<String, String> displayThumbnails,  String? primaryDisplayId,  List<RecordingInfo> recentRecordings,  Display? lockedDisplay,  bool textHasBackground,  bool isLongScreenshotSession,  bool isStitching,  StitchAxis scrollDirection,  String searchQuery, @JsonKey(includeFromJson: false, includeToJson: false)  HotKey? registeredHotKey)  $default,) {final _that = this;
switch (_that) {
case _ScreenRecorderState():
return $default(_that.isRecording,_that.isPaused,_that.durationSeconds,_that.microphoneEnabled,_that.systemAudioEnabled,_that.showCursor,_that.resolution,_that.format,_that.captureMode,_that.isOverlayVisible,_that.availableAudioDevices,_that.selectedAudioDevice,_that.clickFeedbackColor,_that.rightClickFeedbackColor,_that.annotations,_that.currentTool,_that.annotationColor,_that.delaySeconds,_that.countdownSeconds,_that.framerate,_that.saveDirectory,_that.previousWindowSize,_that.previousWindowPos,_that.selectionRect,_that.captureRect,_that.availableDisplays,_that.monitorNames,_that.displayThumbnails,_that.primaryDisplayId,_that.recentRecordings,_that.lockedDisplay,_that.textHasBackground,_that.isLongScreenshotSession,_that.isStitching,_that.scrollDirection,_that.searchQuery,_that.registeredHotKey);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isRecording,  bool isPaused,  int durationSeconds,  bool microphoneEnabled,  bool systemAudioEnabled,  bool showCursor,  String resolution,  String format,  CaptureMode captureMode,  bool isOverlayVisible,  List<String> availableAudioDevices,  String? selectedAudioDevice,  Color clickFeedbackColor,  Color rightClickFeedbackColor,  List<Annotation> annotations,  ScreenshotTool currentTool,  Color annotationColor,  int delaySeconds,  int countdownSeconds,  int framerate,  String? saveDirectory,  Size? previousWindowSize,  Offset? previousWindowPos,  Rect? selectionRect,  Rect? captureRect,  List<Display> availableDisplays,  Map<String, String> monitorNames,  Map<String, String> displayThumbnails,  String? primaryDisplayId,  List<RecordingInfo> recentRecordings,  Display? lockedDisplay,  bool textHasBackground,  bool isLongScreenshotSession,  bool isStitching,  StitchAxis scrollDirection,  String searchQuery, @JsonKey(includeFromJson: false, includeToJson: false)  HotKey? registeredHotKey)?  $default,) {final _that = this;
switch (_that) {
case _ScreenRecorderState() when $default != null:
return $default(_that.isRecording,_that.isPaused,_that.durationSeconds,_that.microphoneEnabled,_that.systemAudioEnabled,_that.showCursor,_that.resolution,_that.format,_that.captureMode,_that.isOverlayVisible,_that.availableAudioDevices,_that.selectedAudioDevice,_that.clickFeedbackColor,_that.rightClickFeedbackColor,_that.annotations,_that.currentTool,_that.annotationColor,_that.delaySeconds,_that.countdownSeconds,_that.framerate,_that.saveDirectory,_that.previousWindowSize,_that.previousWindowPos,_that.selectionRect,_that.captureRect,_that.availableDisplays,_that.monitorNames,_that.displayThumbnails,_that.primaryDisplayId,_that.recentRecordings,_that.lockedDisplay,_that.textHasBackground,_that.isLongScreenshotSession,_that.isStitching,_that.scrollDirection,_that.searchQuery,_that.registeredHotKey);case _:
  return null;
...
class _ScreenRecorderState implements ScreenRecorderState {
  const _ScreenRecorderState({this.isRecording = false, this.isPaused = false, this.durationSeconds = 0, this.microphoneEnabled = true, this.systemAudioEnabled = true, this.showCursor = true, this.resolution = '1080p', this.format = 'MP4', this.captureMode = CaptureMode.fullScreen, this.isOverlayVisible = false, final  List<String> availableAudioDevices = const [], this.selectedAudioDevice, this.clickFeedbackColor = Colors.white, this.rightClickFeedbackColor = Colors.amber, final  List<Annotation> annotations = const [], this.currentTool = ScreenshotTool.pointer, this.annotationColor = Colors.red, this.delaySeconds = 0, this.countdownSeconds = 0, this.framerate = 30, this.saveDirectory, this.previousWindowSize, this.previousWindowPos, this.selectionRect, this.captureRect, final  List<Display> availableDisplays = const [], final  Map<String, String> monitorNames = const {}, final  Map<String, String> displayThumbnails = const {}, this.primaryDisplayId, final  List<RecordingInfo> recentRecordings = const [], this.lockedDisplay, this.textHasBackground = false, this.isLongScreenshotSession = false, this.isStitching = false, this.scrollDirection = StitchAxis.vertical, this.searchQuery = '', @JsonKey(includeFromJson: false, includeToJson: false) this.registeredHotKey}): _availableAudioDevices = availableAudioDevices,_annotations = annotations,_availableDisplays = availableDisplays,_monitorNames = monitorNames,_displayThumbnails = displayThumbnails,_recentRecordings = recentRecordings;
...
@override@JsonKey() final  bool isLongScreenshotSession;
@override@JsonKey() final  bool isStitching;
@override@JsonKey() final  StitchAxis scrollDirection;
...
as String,captureMode: null == captureMode ? _self.captureMode : captureMode // ignore: cast_nullable_to_non_nullable
as CaptureMode,isOverlayVisible: null == isOverlayVisible ? _self.isOverlayVisible : isOverlayVisible // ignore: cast_nullable_to_non_nullable
as bool,availableAudioDevices: null == availableAudioDevices ? _self._availableAudioDevices : availableAudioDevices // ignore: cast_nullable_to_non_nullable
as List<String>,selectedAudioDevice: freezed == selectedAudioDevice ? _self.selectedAudioDevice : selectedAudioDevice // ignore: cast_nullable_to_non_nullable
as String?,clickFeedbackColor: null == clickFeedbackColor ? _self.clickFeedbackColor : clickFeedbackColor // ignore: cast_nullable_to_non_nullable
as Color,rightClickFeedbackColor: null == rightClickFeedbackColor ? _self.rightClickFeedbackColor : rightClickFeedbackColor // ignore: cast_nullable_to_non_nullable
