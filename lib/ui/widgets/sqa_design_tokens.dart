...
class SqaTokens {
  ...
  static const double scrollClearanceBottom =
      160.0; // Scroll clearance padding for standard editors/viewers

  static const double fontSizeTiny = 11.0;
  static const double fontSizeSmall =
      12.0; // Standardized for labels/secondary text
  ...
  static TextStyle mono(
    ...
    double? fontSize,
    Color? color,
  }) => GoogleFonts.jetBrainsMono(fontSize: fontSize, color: color);
}
