...
@override
int get hashCode => Object.hashAll([runtimeType,isRecording,isPaused,durationSeconds,microphoneEnabled,systemAudioEnabled,showCursor,resolution,format,captureMode,targetWindowName,isOverlayVisible,isTargetingWindow,targetedWindowRect,targetedWindowHwnd,const DeepCollectionEquality().hash(availableAudioDevices),selectedAudioDevice,clickFeedbackColor,rightClickFeedbackColor,const DeepCollectionEquality().hash(annotations),currentTool,annotationColor,delaySeconds,countdownSeconds,framerate,engineDownloadProgress,engineReady,saveDirectory,previousWindowSize,previousWindowPos,selectionRect,captureRect,const DeepCollectionEquality().hash(availableDisplays),const DeepCollectionEquality().hash(monitorNames),const DeepCollectionEquality().hash(displayThumbnails),primaryDisplayId,const DeepCollectionEquality().hash(recentRecordings)]);
