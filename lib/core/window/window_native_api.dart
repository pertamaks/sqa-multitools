...
/// If no implementation is registered, the built-in [_WindowNativeApiStub]
...
/// 2. In `main.dart`, add an `else if (Platform.isX)` branch and call
///    `WindowNativeApi.register(WindowNativeApiX())`.
...
abstract class WindowNativeApi {
  ...
  static WindowNativeApi _instance = const _WindowNativeApiStub();
...
// ---------------------------------------------------------------------------
// Built-in stub — used when no platform implementation is registered.
// ---------------------------------------------------------------------------

class _WindowNativeApiStub implements WindowNativeApi {
  const _WindowNativeApiStub();
